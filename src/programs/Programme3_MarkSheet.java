...
/**
 * Write a java program to input the student Name,roll No,and three subjects Math,Science and English marks
 * (marks is between 0 to 100 and if it is out of range print error message "Invalid Input,Marks should be between 0 to 100")
 * and find out its total , percentage , and result. If he is pass or fail on the basis of percentage (pass>=35)
 * and also give them garde if %> = 60 A, %> = 50 B, %> = 35 C And print Mark Sheet in following format
